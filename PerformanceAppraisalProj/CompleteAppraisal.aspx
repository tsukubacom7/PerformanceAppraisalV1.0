<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="CompleteAppraisal.aspx.cs" Inherits="PerformanceAppraisalProj.CompleteAppraisal" %>
                ...
                <tr>
                    <td colspan="4">
                        <asp:GridView ID="gvEmployee" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                            ...
                            PageSize="20" OnPageIndexChanging="gvEmployee_PageIndexChanging" OnRowDataBound="gvEmployee_RowDataBound">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Detail">
                                    <ItemTemplate>
                                        ...
                                        <asp:HyperLink ID="hplClick" runat="server" Target="_blank"
                                            NavigateUrl='<%# Eval("EmployeeID","~/Form/CompletePerformanceAppraisal.aspx?EmployeeID={0}") %>'>Click</asp:HyperLink>
                                    </ItemTemplate>
