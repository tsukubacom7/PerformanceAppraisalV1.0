...
{
    public partial class PerformanceAppraisalReject : System.Web.UI.Page
    {
        private static log4net.ILog logger = log4net.LogManager.GetLogger(typeof(PerformanceAppraisalReject));       
        ...
        private void InitialEmpDetail()
        {
            ...
            if (empData != null)
            {
                ...
                hdfFirstManagerName.Value = empData.FirstManager;
        ...
        private void BindGridViewEdit1()
        {
            try
            {
        ...
        private void BindGridViewEdit2()
        {
            try
            {
                List<AppraisalDocLine> lUser = new List<AppraisalDocLine>();
        ...
        protected void gvAppraisalPart1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                ...
                {
                    HiddenField hdfScore = (HiddenField)e.Row.FindControl("hdfScore");
                    HiddenField hdfCalculatedScore = (HiddenField)e.Row.FindControl("hdfCalculatedScore");
                    DropDownList ddlPart1Result = (DropDownList)e.Row.FindControl("ddlPart1Result");
                    Label lblPart1Score = (Label)e.Row.FindControl("lblPart1Score");
                    ...
                    if (ddlPart1Result != null)
                    {
                        ddlPart1Result.SelectedValue = hdfScore.Value;
                    }
                }
            }
            catch (Exception ex)
        ...
        protected void gvAppraisalPart2_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                ...
                {
                    HiddenField hdfScore = (HiddenField)e.Row.FindControl("hdfScore");
                    DropDownList ddlPart2Result = (DropDownList)e.Row.FindControl("ddlPart2Result");
                    if (ddlPart2Result != null)
                    {
                        ddlPart2Result.SelectedValue = hdfScore.Value;
                    }
        ...
        private string GenEmailBody(string EmpID, string SecManagerName, string ReqName, string ReqDate, string EmployeeName,
            string Position, string Status, string FirstManagerName)
        {
            ...
            string _1ndManagerName = FirstManagerName;
