<%@ Page Title="Performance Appraisal" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="PerformanceAppraisalHistory.aspx.cs" Inherits="PerformanceAppraisalProj.Form.PerformanceAppraisalHistory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="updGrid" UpdateMode="Conditional" runat="server">
        <ContentTemplate>
            <table class="auto-style1">
                ...
                <tr>
                    <td colspan="4">
                        <asp:GridView ID="gvAttachFile" runat="server" AllowPaging="true" AllowSorting="false" AutoGenerateColumns="false" 
                            CssClass="GridView2" 
                            EmptyDataText="No data found" EnableViewState="true" ForeColor="#3333333" GridLines="Both" 
                            OnRowCommand="gvAttachFile_RowCommand" OnRowDataBound="gvAttachFile_RowDataBound" 
                            OnRowDeleting="gvAttachFile_RowDeleting" ShowHeader="true" ShowHeaderWhenEmpty="true" Width="70%" 
                            ...
                            <RowStyle BackColor="#F7F6F3" ForeColor="#333333" />
                            <Columns>
                                <asp:BoundField DataField="FileName" HeaderText="File Name" ItemStyle-Font-Size="12px" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="40%" />
                                <asp:TemplateField>
                                    <ItemStyle Font-Size="12px" HorizontalAlign="Center" Width="10%" />
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkDownload" runat="server" CausesValidation="False" CommandArgument='<%#Eval("Attachment")%>' CommandName="Download" OnClick="lnkDownload_Click" Text="Download" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                            <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                ...
                <tr>
                    <td colspan="4">
                        <asp:Button ID="btnClose" runat="server" OnClientClick="window.close(); return false;" Text="Close" Width="100px" />
                    </td>
                </tr>
            </table>
        </ContentTemplate>
    ...
    <asp:HiddenField ID="hdfPerformanceYear" runat="server" />
</asp:Content>
