<%@ Page Title="Performance Appraisal" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="PerformanceAppraisalReject.aspx.cs" Inherits="PerformanceAppraisalProj.Form.PerformanceAppraisalReject" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="updGrid" UpdateMode="Conditional" runat="server">
        <ContentTemplate>
                    ...
                    <td colspan="4">
                        <asp:GridView ID="gvEmployee" runat="server" AllowPaging="True" AutoGenerateColumns="False" EmptyDataText="No data found." EnableViewState="true" ForeColor="#333333" GridLines="Vertical" OnPageIndexChanging="gvEmployee_PageIndexChanging" OnRowDataBound="gvEmployee_RowDataBound" PageSize="5" ShowHeaderWhenEmpty="True" Width="100%">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="AppraisalDate" DataFormatString="{0:dd\/MM\/yyyy}" HeaderText="Appraisal Date" HtmlEncode="false" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="12%" />
                ...
                <tr>
                    <td colspan="4">
                        <asp:GridView ID="gvActionHistory" runat="server" AllowPaging="True" AutoGenerateColumns="False" 
                            ...
                            OnPageIndexChanging="gvActionHistory_PageIndexChanging" PageSize="5" 
                            ShowHeaderWhenEmpty="True" Width="100%" OnRowDataBound="gvActionHistory_RowDataBound">
                            <AlternatingRowStyle BackColor="#f9f9f9" ForeColor="Black" />
                            <PagerSettings Mode="NumericFirstLast" PageButtonCount="4" />
                            <HeaderStyle BackColor="#5D7B9D" Font-Bold="false" Font-Size="12px" ForeColor="White" />
                            <FooterStyle BackColor="#5D7B9D" Font-Bold="false" ForeColor="White" />
                ...
                <tr>
                    <td colspan="4">
                        <asp:GridView ID="gvAppraisalPart1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                            ...
                            Width="100%" OnRowDataBound="gvAppraisalPart1_RowDataBound" EnableViewState="true">
                            <AlternatingRowStyle BackColor="#f9f9f9" ForeColor="Black" />
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Agree Result">
                                    <ItemTemplate>
                                        <asp:DropDownList ID="ddlPart1Result" runat="server" Width="90%" 
                                            CssClass="TextAreaRemark"
                                ...
                                <asp:TemplateField HeaderText="Score">
                                    <ItemTemplate>
                                        ...
                                        <asp:HiddenField ID="hdfScore" runat="server" Value='<%# Eval("Score") %>' />
                                        <asp:HiddenField ID="hdfCalculatedScore" runat="server" Value='<%# Eval("CalculatedScore") %>' />
                                        <asp:Label ID="lblPart1Score" runat="server" Text='<%# Eval("CalculatedScore") %>'></asp:Label>
                                    </ItemTemplate>
                                    <ItemStyle Width="10%" HorizontalAlign="Center" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Comment">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtPart1Comment" runat="server" 
                                            CssClass="TextAreaRemark" Text='<%# Eval("Remark") %>'></asp:TextBox>
                                    </ItemTemplate>
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Score">
                                    <ItemTemplate>
                                        ...
                                        <asp:HiddenField ID="hdfScore" runat="server" Value='<%# Eval("Score") %>' />
                                        <asp:Label ID="lblPart2Score" runat="server" Text='<%# Eval("CalculatedScore") %>'></asp:Label>
                                    </ItemTemplate>
                                    <ItemStyle Width="10%" HorizontalAlign="Center" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Comment">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtPart2Comment" runat="server" 
                                            CssClass="TextAreaRemark" Text='<%# Eval("Remark") %>'></asp:TextBox>
                                    </ItemTemplate>
                                    <ItemStyle Width="30%" HorizontalAlign="Center" />
                                </asp:TemplateField>
                ...
                <tr>
                    <td class="auto-style2" colspan="4">
                        <table style="border-collapse: collapse; border: 1px solid black;" width="100%">
                            <tr>
                                <td class="auto-style28" colspan="2" style="background-color: lavender; border: 1px solid black;">
                                    <asp:Label ID="Label31" runat="server" Font-Bold="True" Text="ค่าน้ำหนัก"></asp:Label>
                                </td>
                                <td class="auto-style28" style="border: 1px solid black;">
                            ...
                            <tr>
                                <td class="auto-style25" style="border: 1px solid black;">
                    ...
                    <td class="auto-style2" colspan="4">
                        <table style="border-collapse: collapse;" width="100%">
                            <tr>
                                ...
                                <td class="auto-style28" style="border: 1px solid black;"><strong>
                            ...
                            <tr>
                                ...
                                <td class="auto-style28" rowspan="3" style="border: 1px solid black;">
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:GridView ID="gvAttachFile" runat="server" AllowPaging="True" AutoGenerateColumns="False" 
                                        ...
                                        OnRowDataBound="gvAttachFile_RowDataBound" OnRowDeleting="gvAttachFile_RowDeleting" ShowHeaderWhenEmpty="True" Width="70%" OnPageIndexChanging="gvAttachFile_PageIndexChanging" PageSize="5">
                                        <AlternatingRowStyle BackColor="#f9f9f9" ForeColor="Black" />
                                        <PagerSettings FirstPageText="First" LastPageText="Last" Mode="NumericFirstLast" PageButtonCount="4" />
                                             ...
                                             <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="12%">
                                                ...
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkDownload" runat="server" CausesValidation="False"
                                                        CommandArgument='<%# Eval("AttachFilePath") %>' 
                                                        CommandName="Download" OnClick="lnkDownload_Click"
                                                        Text="Download" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
            ...
            <asp:HiddenField ID="hdfFirstManagerName" runat="server" />
