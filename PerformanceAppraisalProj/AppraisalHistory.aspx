<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="AppraisalHistory.aspx.cs" Inherits="PerformanceAppraisalProj.AppraisalHistory" %>
            ...
            <table class="auto-style1">
                <tr>
                    <td colspan="4" class="auto-style11">
                        <asp:Label ID="Label8" runat="server" Text="Performance Appraisal History" Font-Size="Medium"></asp:Label>
                    </td>
                </tr>
                <tr>
                        ...
                        <asp:GridView ID="gvEmployee" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Appraisal Status" DataField="AppraisalStatus">
                                    <ItemStyle Width="19%" HorizontalAlign="Center"></ItemStyle>
                                </asp:BoundField>
                                <asp:BoundField HeaderText="Appraisal Year" DataField="AppraisalYear">
                                ...
                                <asp:TemplateField HeaderText="Detail">
                                    <ItemTemplate>
                                        ...
                                        <asp:HiddenField ID="hdfYear" runat="server" Value='<%# Eval("AppraisalYear") %>' />
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:HiddenField ID="hdfUserLoginID" runat="server" />
                    </td>
                </tr>
            </table>
        </ContentTemplate>
